<%-- 
    Document   : addQuestionGetCount
    Created on : 25-Jun-2022, 12:33:50 pm
...
<html lang="en">
    <head>
        ...
        <title>Get Questions Count</title>
    </head>
    <body style="font-family: 'Poppins', sans-serif;">
        <form method="post" action="addQuestions.jsp">
            <div class="wrapper rounded bg-white">

                <div class="h3">Enter Number of Questions </div>

                <div class="form">
                    <div class="col-md-6 mt-md-0 mt-3">
                        <label>Number of Questions</label>
                        <input type="text"  class="form-control" name="noq" required>
                    </div>
                    <%
