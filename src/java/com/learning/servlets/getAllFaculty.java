...
public class getAllFaculty extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ArrayList<faculty> allFac = new ArrayList<faculty>();
            
            FacultyDao dao = new FacultyDao(ConnectionProvider.getConnection());
            allFac = dao.getAllFaculty();
            HttpSession s = request.getSession();
            s.setAttribute("allFac", allFac);
            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("http://localhost:8888/E-learning/admin.jsp");
